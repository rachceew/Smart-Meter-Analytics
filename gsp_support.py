...
def gspclustering_event2(event,delta_p,sigma):
  ...
  winL = 200 #this define  number of observations in a window, the algorthm works in a sliding window manner
  # print('winL is', winL)
